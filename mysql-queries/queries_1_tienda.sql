...
SELECT p.nombre, p.precio, f.nombre as fabricante FROM producto as p LEFT JOIN fabricante as f ON p.codigo_fabricante = f.codigo;
...
SELECT p.nombre, p.precio, f.nombre as fabricante FROM producto as p LEFT JOIN fabricante as f ON p.codigo_fabricante = f.codigo ORDER BY f.nombre;

-- 23. Retorna una llista amb el codi del producte, nom del producte, codi del fabricador i nom del fabricador, de tots els productes de la base de dades.
SELECT p.codigo, p.nombre, p.codigo_fabricante, f.nombre as fabricante FROM producto as p LEFT JOIN fabricante as f ON p.codigo_fabricante = f.codigo;

-- 24. Retorna el nom del producte, el seu preu i el nom del seu fabricant, del producte més barat.
SELECT p.nombre, p.precio, f.nombre as fabricante FROM producto as p LEFT JOIN fabricante as f ON p.codigo_fabricante = f.codigo ORDER BY precio ASC LIMIT 1;

-- 25. Retorna el nom del producte, el seu preu i el nom del seu fabricant, del producte més car.
SELECT p.nombre, p.precio, f.nombre as fabricante FROM producto as p LEFT JOIN fabricante as f ON p.codigo_fabricante = f.codigo ORDER BY precio DESC LIMIT 1;

-- 26. Retorna una llista de tots els productes del fabricador Lenovo
SELECT p.* FROM producto as p LEFT JOIN fabricante as f ON p.codigo_fabricante = f.codigo WHERE f.nombre="Lenovo";

-- 27. Retorna una llista de tots els productes del fabricant Crucial que tinguin un preu major que 200€.
SELECT p.* FROM producto as p LEFT JOIN fabricante as f ON p.codigo_fabricante = f.codigo WHERE f.nombre="Crucial" and precio>200;
...
SELECT p.nombre, p.precio, f.nombre as fabricante FROM producto as p LEFT JOIN fabricante as f ON p.codigo_fabricante = f.codigo WHERE f.nombre LIKE '%e';

-- 31. Retorna un llistat amb el nom i el preu de tots els productes el nom de fabricant dels quals contingui el caràcter w en el seu nom
SELECT p.nombre, p.precio, f.nombre as fabricante FROM producto as p LEFT JOIN fabricante as f ON p.codigo_fabricante = f.codigo WHERE f.nombre LIKE '%w%';
...
SELECT p.nombre, p.precio, f.nombre as fabricante FROM producto as p LEFT JOIN fabricante as f ON p.codigo_fabricante = f.codigo WHERE p.precio>=180 ORDER BY precio DESC, nombre ASC;

-- 33. Retorna un llistat amb el codi i el nom de fabricant, solament d'aquells fabricants que tenen productes associats en la base de dades.
SELECT f.* FROM producto as p LEFT JOIN fabricante as f ON p.codigo_fabricante = f.codigo GROUP BY f.codigo;
...
SELECT f.* FROM producto as p RIGHT JOIN fabricante as f ON p.codigo_fabricante = f.codigo WHERE p.codigo IS NULL;

-- 36. Retorna tots els productes del fabricador Lenovo. (Sense utilitzar INNER JOIN).
SELECT * FROM producto as p RIGHT JOIN fabricante as f ON p.codigo_fabricante = f.codigo WHERE f.nombre = "Lenovo";
...
SELECT * FROM producto as p LEFT JOIN fabricante as f ON p.codigo_fabricante = f.codigo WHERE p.precio = (SELECT max(precio) from producto where codigo_fabricante = 2);

-- 38. Llista el nom del producte més car del fabricador Lenovo.
SELECT p.nombre FROM producto as p LEFT JOIN fabricante as f ON p.codigo_fabricante = f.codigo WHERE f.nombre = "Lenovo" ORDER BY precio DESC LIMIT 1;

-- 39. Llista el nom del producte més barat del fabricant Hewlett-Packard.
SELECT p.nombre FROM producto as p LEFT JOIN fabricante as f ON p.codigo_fabricante = f.codigo WHERE f.nombre = "Hewlett-Packard" ORDER BY precio ASC LIMIT 1;
...
SELECT p.* FROM producto as p LEFT JOIN fabricante as f ON p.codigo_fabricante = f.codigo WHERE p.precio >= (SELECT max(precio) from producto where codigo_fabricante = 2);

-- 41. Llesta tots els productes del fabricador Asus que tenen un preu superior al preu mitjà de tots els seus productes.
SELECT p.* FROM producto as p LEFT JOIN fabricante as f ON p.codigo_fabricante = f.codigo WHERE f.nombre="Asus" AND p.precio > (SELECT AVG(precio) from producto where codigo_fabricante = 1);