...
SELECT nombre as 'nom de producte', precio as euro, (precio*1.13) as dolar FROM producto;
...
SELECT * FROM producto as p RIGHT JOIN fabricante as f ON p.codigo_fabricante = f.codigo WHERE p.codigo IS NULL;
